<template id="movement-add">
    <v-app id="inspire">
        <div>
            <h3 class="mb-5">Add new movement</h3>
...
<!--            </div>-->
            ...
            <form>
                ...
                <div class="form-group row">
                    <label for="add-code" class="col-2 col-form-label">Movement Code</label>
                    <div class="col-10">
                        <input class="form-control" placeholder="Код должен быть уникальным и состоять из трех цифр. В данной версии уникальность кода - ответственность пользователя) " id="add-code" v-model="movement.code"/>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="add-name" class="col-2 col-form-label">Movement Name</label>
                    <div class="col-10">
